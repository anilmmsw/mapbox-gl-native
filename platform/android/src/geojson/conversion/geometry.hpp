...
public:
    ...
    jni::jobject* operator()(const mapbox::geometry::line_string<T> &geometry) const {
        ...
        // Create
        jni::LocalObject<jni::jarray<jni::jobject>> listOfPoints = jni::NewLocalObject(env, toGeoJsonListOfPoints(env, geometry));
    ...
    jni::jobject* operator()(const mapbox::geometry::multi_point<T> &geometry) const {
        ...
        // Create
        jni::LocalObject<jni::jarray<jni::jobject>> coordinates = jni::NewLocalObject(env, toGeoJsonListOfPoints(env, geometry));
    ...
    jni::jobject*  operator()(const mapbox::geometry::geometry_collection<T> &collection) const {
        ...
        static jni::jmethodID* fromGeometries = &jni::GetStaticMethodID(env, *javaClass, "geometries", "(Ljava/util/List;)Lcom/mapbox/geojson/GeometryCollection;");
...
//    }
   ...
   */
    static jni::jobject* toGeoJsonListOfPoints(JNIEnv& env, std::vector<mapbox::geometry::point<T>> points) {
        ...
        static jni::jmethodID* add = &jni::GetMethodID(env, *javaClass, "add", "(Ljava/lang/Object;)Z");
        ...
        for(size_t i = 0; i < points.size(); i = i + 1) {
            ...
            jni::LocalObject<jni::jobject> pointObject =
                    jni::NewLocalObject(env, jni::CallStaticMethod<jni::jobject*>(env, *javaClass, *fromLngLat, point.x, point.y));
            jni::CallMethod<void>(env, arrayList, *add, pointObject.get());
        }
    ...
    static jni::jobject* toShape(JNIEnv& env, SHAPE value) {
        ...
        for(size_t i = 0; i < value.size(); i = i + 1) {
            ...
            jni::CallMethod<void>(env, arrayList, *add, listOfPoints.get());
        }
